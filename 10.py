...
# obj=Solution()
# # print('t',obj.isMatch("aab","c*a*b"))
# # print('t',obj.isMatch("aab","c*a.b"))
# # print('f',obj.isMatch("aab","c*a..b"))
# # print('t',obj.isMatch("aaab","c*a..b"))
# # print('t',obj.isMatch("aaab","c*a*b"))
# # print('f',obj.isMatch("aa","a"))
# # print('t',obj.isMatch("aa","a."))
# # print('t',obj.isMatch("aa","a*"))
# # print('t',obj.isMatch("ab",".*"))
# # print('f',obj.isMatch("mississippi","mis*is*p*."))
# # print('t',obj.isMatch("aaa","ab*ac*a"))
# # print('f',obj.isMatch("ab",".*c"))
# print('t',obj.isMatch("a","ab*"))
# print('t',obj.isMatch("aaaa","a*b*a"))
# print('f',obj.isMatch("aaaa","a*ba"))
# print('f',obj.isMatch("aaa","aaaa"))
# print('f',obj.isMatch("aaaa","aaa"))
